...
export default function RetrainingPanel() {
  ...
  const loadTrainingDataPreview = async () => {
    try {
      const response = await fetch('/api/retraining/faces-for-training');
      const data = await response.json();
  ...
  const loadQualityMetrics = async () => {
    try {
      const response = await fetch('/api/retraining/quality-metrics');
      const data = await response.json();
  ...
  const handleStartRetraining = async () => {
    ...
    try {
      const response = await fetch('/api/retraining/full', {
        method: 'POST',
